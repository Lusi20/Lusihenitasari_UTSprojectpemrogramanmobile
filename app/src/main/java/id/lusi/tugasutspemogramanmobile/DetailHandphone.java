package id.lusi.tugasutspemogramanmobile;
...
import id.lusi.tugasutspemogramanmobile.model.Handphone;
import id.lusi.tugasutspemogramanmobile.server.AsyncInvokeURLTask;
import org.apache.http.NameValuePair;
import org.apache.http.message.BasicNameValuePair;
import java.util.ArrayList;

public class
DetailHandphone extends AppCompatActivity {
    ...
    private void delete() {
        ...
        AlertDialog alert = builder.create();alert.setIcon(android.R.drawable.ic_menu_delete);
        alert.show();
    }
